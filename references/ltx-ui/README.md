# ltx.io — design system pack

> Built from `https://ltx.io` on 2026-06-02 by [designlang](https://designlang.app) v12.15.0.

A single, polished bundle of every artifact designlang emits for ltx.io: tokens, components, a runnable Storybook, a minimal starter, and paste-ready prompts for v0 / Lovable / Cursor / Claude Artifacts.

## At a glance

- **Grade:** C (78/100)
- **Stack:** unknown · component library: unknown
- **Type families:** Aeonik, Miriam Libre, Times
- **Palette:** 22 colors
- **Spacing base:** 2
